...
//-----------------------------------------------------------------------------
// qIzaAppMainWindowPrivate methods

qIzaAppMainWindowPrivate::qIzaAppMainWindowPrivate(qIzaAppMainWindow& object)
  : Superclass(object)
{
}

//-----------------------------------------------------------------------------
qIzaAppMainWindowPrivate::~qIzaAppMainWindowPrivate()
{
}

//-----------------------------------------------------------------------------
void qIzaAppMainWindowPrivate::init()
{
#if (QT_VERSION >= QT_VERSION_CHECK(5, 7, 0))
  QApplication::setAttribute(Qt::AA_UseHighDpiPixmaps);
#endif
  Q_Q(qIzaAppMainWindow);
  this->Superclass::init();
}

//-----------------------------------------------------------------------------
void qIzaAppMainWindowPrivate::setupUi(QMainWindow * mainWindow)
{
  ...
  helpAboutSlicerAppAction->setObjectName("HelpAboutIzaAppAction");
...
//-----------------------------------------------------------------------------
// qIzaAppMainWindow methods

//-----------------------------------------------------------------------------
qIzaAppMainWindow::qIzaAppMainWindow(QWidget* windowParent)
  : Superclass(new qIzaAppMainWindowPrivate(*this), windowParent)
{
  Q_D(qIzaAppMainWindow);
  d->init();
}

//-----------------------------------------------------------------------------
qIzaAppMainWindow::qIzaAppMainWindow(
  qIzaAppMainWindowPrivate* pimpl, QWidget* windowParent)
...
//-----------------------------------------------------------------------------
void qIzaAppMainWindow::on_HelpAboutIzaAppAction_triggered()
{
  ...
  QString acknowledgmentText(
      ...
      "Iza is a  software package for medical image segmentation's "
