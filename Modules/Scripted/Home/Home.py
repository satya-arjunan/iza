...
class Home:
    def __init__(self, parent):
        ...
        <br>
        <b>Welcome to Iza!</b><br>
        <br>
        Visit <a href="https://salt.slicer.org">salt.slicer.org</a> for more information about Iza.<br>
        <br>
        Documentation and tutorials can be found at: <a href="https://salt.slicer.org/docs/">salt.slicer.org/docs/</a><br>
        </center>
        """
        parent.acknowledgementText = """
        <center> <br>Iza is an open source software package for doing shape analysis of image segmentations using different methods. <br>
        ...
        <br> Iza is supported by NIH and the Slicer Community. <br>
        </center>
        """
