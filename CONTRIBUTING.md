...
---
## Forking workflow
To contribute your changes to Iza, you will need to follow the forking workflow.

1. [Fork the Iza Repository] to your own github space, and add it to your git source directory

```sh
 git remote add custom-remote-name git@github.com:{github-space-name}/Iza.git
 ```

2. Create an issue on Iza's issue tracker (optional step for minor changes)
>
> https://github.com/Kitware/Iza/issues
...
5. Push your branch to your fork of Iza
...
8. Once your changes have been reviewed and the associated builds and tests pass on [Iza dashboards](#dashboards), your branch will be merged into `master`.

9. Once your changes have been reviewed and merged into the `master` branch of Iza, you may get rid of your development branch and pull the latest commits from the master branch, then repeat from step 2 for further development
...
Coming soon!
 ...
 [Fork the Iza Repository]: https://help.github.com/articles/fork-a-repo/
